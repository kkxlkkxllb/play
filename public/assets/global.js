...
var MathUtils = function () {
    ...
    Simulator = function () {
        ...
        return {
            init: function () {
                (B = tk("awards-container")) && AwardsOverlay.init();
                Sys.isOnline || (q = -100);
                u = tk("device");
                v = tk("device-reflection");
                w = tk("main");
    ...
    AwardsOverlay = function () {
        ...
        return {
            init: function () {
                k = tk("awards-container");
                Utils.transform2(k,
                    0, 0);
                g = tk("awards-play-btn");
                g.addEventListener("click", a, !1);
                q = tk("awards-close-btn");
